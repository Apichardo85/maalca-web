  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className="max-w-4xl w-full bg-slate-900 text-stone-100 rounded-2xl border border-red-800/30 shadow-2xl max-h-[90vh] overflow-hidden flex flex-col animate-slide-in-up"
          >
            {/* Header */}
