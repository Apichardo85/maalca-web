...
const translations = {
  es: {
    ...
    'home.hero.title2': 'Necesitas tu',
    'home.hero.titleHighlight': 'espacio digital',
    'home.hero.subtitle': 'Crea, personaliza, publica y gestiona el espacio digital de tu negocio. Sin código. Sin plantillas genéricas.',
    'home.hero.ctaPrimary': 'Crear mi espacio gratis',
    'home.hero.ctaSecondary': 'Ver ejemplos reales →',
    'home.hero.mockupAlt': 'Panel de módulos del espacio digital de un afiliado en MaalCa',
    'home.showcase.heading': 'Negocios reales, espacios reales',
    'home.showcase.subtitle': 'Nada de mockups — así lucen hoy en producción',
    'home.showcase.footnote': 'Retail (BritoColor) se suma cuando el catálogo esté publicado — no mostramos mockups como si fueran reales.',
    'home.showcase.prevImage': 'Imagen anterior',
    'home.showcase.nextImage': 'Imagen siguiente',
    'home.showcase.viewImage': 'Ver imagen',
    'home.showcase.zoomImage': 'Ampliar imagen',
    'home.showcase.close': 'Cerrar',
    'home.showcase.pegote.pill': 'Barbería — Pegote',
    'home.showcase.pegote.category': 'BARBERÍA',
    'home.showcase.pegote.description': 'Template dinámico ya sirviendo en producción — reservas, catálogo de servicios y perfil del negocio, todo desde un mismo espacio.',
    'home.showcase.pegote.img.waitingQueue': 'Fila de espera en tiempo real de Pegote Barbershop en MaalCa',
    'home.showcase.pegote.img.screenBoard': 'Pantalla pública con la fila y el menú de servicios de Pegote Barbershop en MaalCa',
    'home.showcase.pegote.img.agenda': 'Agenda de citas por barbero de Pegote Barbershop en MaalCa',
    'home.showcase.pegote.img.booking': 'Página pública de reservas con el equipo de barberos de Pegote Barbershop en MaalCa',
    'home.showcase.pegote.img.branding': 'Personalización de marca y espacio digital de Pegote Barbershop en MaalCa',
    'home.showcase.littleDominican.pill': 'Restaurante — The Little Dominican',
    'home.showcase.littleDominican.category': 'RESTAURANTE',
    'home.showcase.littleDominican.description': 'Menú, modificadores y pedidos gestionados desde el mismo panel — sin plantillas genéricas para un restaurante real.',
    'home.showcase.littleDominican.img.kitchen': 'Pantalla de cocina (KDS) de The Little Dominican en MaalCa',
    'home.showcase.littleDominican.img.pos': 'Punto de venta de The Little Dominican en MaalCa',
    'home.showcase.littleDominican.img.catalog': 'Catálogo / menú de The Little Dominican en MaalCa',
    'home.showcase.littleDominican.img.orders': 'Pedidos de The Little Dominican en MaalCa',
    'home.showcase.littleDominican.img.dashboard': 'Panel principal de The Little Dominican en MaalCa',
    'home.showcase.littleDominican.img.stats': 'Estadísticas de The Little Dominican en MaalCa',
    'home.showcase.littleDominican.img.qrCard': 'Código QR y tarjeta de negocio de The Little Dominican en MaalCa',
    'home.steps.heading': 'Así de simple',
    'home.steps.1': 'Crea tu espacio',
    'home.steps.2': 'Personaliza tu marca',
    'home.steps.3': 'Publica en un clic',
    'home.steps.4': 'Gestiona todo desde ahí',
    'home.cta.heading': '¿Listo para tener tu espacio digital?',
    'home.cta.subtitle': 'Sin tarjeta de crédito. Publica hoy mismo.',
    // Navigation
    'nav.home': 'Inicio',
    ...
    'footer.product.platform': 'Plataforma',
    'footer.product.cases': 'Casos',
    ...
    // Homepage Hero
    'hero.eyebrow': 'TRANSFORMACIÓN DIGITAL PARA NEGOCIOS',    'hero.maalca': 'Hacemos crecer tu negocio,',
    'hero.ecosystem': 'una etapa a la vez.',
        'hero.subtitle': 'MaalCa te da presencia digital lista en minutos — catálogo, canales de contacto y tu página, sin código. Empieza gratis.',
    'hero.cta.projects': 'Empieza gratis — sin tarjeta',
    'hero.cta.join': 'Ver cómo funciona',
    // Ecosystem Section
    ...
    // Affiliates Section
    'affiliates.title': 'Negocios que confían en nosotros',
    'affiliates.description': 'Clientes reales con presencia física en nuestra comunidad',
    'cases.title': 'Negocios que ya operan con MaalCa',
    'platform.title': 'Capacidades que se activan cuando las necesitas',
    'platform.subtitle': 'Módulos que trabajan juntos, no en silos — vas sumando según crece tu negocio.',
    ...
    'platform.mod.analytics.desc': 'Dashboard con visitas, escaneos de QR y clics por canal.',
    'platform.mod.identity': 'Identidad de marca',
    'platform.mod.identity.desc': 'QR con tu color, tarjeta de negocio descargable, todo listo para compartir por WhatsApp.',
    ...
    'how.title': 'Así avanzas, paso a paso',    'how.subtitle': 'Del primer contacto a tu negocio operando — sin fricción, sin código.',
    'how.step1.title': 'Crea tu cuenta',
    'how.step1.desc': 'Entras con Google. Sin llamadas, sin esperar a nadie.',
    'how.step2.title': 'Arma tu espacio',
    'how.step2.desc': 'Nombre, tipo de negocio, color, logo y WhatsApp. Tú mismo, en minutos.',
    'how.step3.title': 'Completa tu catálogo y tus canales',
    'how.step3.desc': 'Productos, servicios o menú, con fotos y precios reales. WhatsApp, redes, horario — todo lo que tus clientes necesitan saber.',
    'how.step4.title': 'Comparte tu QR y mide resultados',
    'how.step4.desc': 'Tu código QR, tu link y tu tarjeta de negocio, listos para compartir. Dashboard de estadísticas en tiempo real para saber qué está funcionando.',
    'pricing.title': 'Planes para cada etapa',
    'pricing.subtitle': 'Empieza gratis y suma capacidades a tu ritmo, sin perder lo que ya construiste.',
    'pricing.plan.cta': 'Ver plan completo →',
    ...
    'cta.final.subtitle': 'Tu primera página, catálogo y código QR: gratis para siempre. El resto lo sumas cuando tu negocio lo pida.',
    'cta.final.btn': 'Crear mi cuenta gratis →',    'beyond.title': 'Más allá del negocio',    'beyond.subtitle': 'MaalCa también es una imprenta y una voz literaria.',    'beyond.editorial.title': 'Editorial MaalCa',    'beyond.editorial.desc': 'Publicamos libros con un precio justo, o gratis si la obra nos atraviesa.',    'beyond.editorial.cta': 'Conoce la editorial →',    'beyond.ciri.title': 'CiriWhispers',    'beyond.ciri.desc': 'El espacio literario del fundador. Narrativa, poesía y cartas. Escritura humana, sin algoritmos.',    'beyond.ciri.cta': 'Leer →',    'editorial.hero.eyebrow': 'Editorial independiente',    'editorial.hero.title': 'Publicar tu libro no debería costarte tus ahorros.',    'editorial.hero.subtitle': 'Tampoco debería depender de que alguien con poder te diga sí. En Editorial MaalCa hacemos las dos cosas: te ayudamos a publicar tu obra por un precio justo, o si nos atraviesa, la publicamos sin que pagues nada.',    'editorial.hero.cta.primary': 'Publica con nosotros',    'editorial.hero.cta.secondary': 'Ver catálogo',    'editorial.tracks.title': 'Dos formas de publicar',    'editorial.track.assisted.title': 'Track Asistido',    'editorial.track.assisted.price': '$185 USD',    'editorial.track.assisted.subtitle': 'Para quien tiene la obra lista',    'editorial.track.curated.title': 'Track Curado',    'editorial.track.curated.price': 'Gratis',    'editorial.track.curated.subtitle': 'Para obras que nos atraviesan',    'editorial.tech.title': 'Tecnología que abarata. Curaduría que importa.',    'editorial.tech.ai.title': 'Lo que automatizamos',    'editorial.tech.human.title': 'Lo que NO automatizamos',    'casos.title': 'Implementaciones reales',    'casos.subtitle': 'NEGOCIOS REALES. RESULTADOS HONESTOS.',    'casos.coming': 'PRÓXIMAMENTE',    'casos.coming.desc': 'Estamos sumando nuevos negocios. Cada cliente es una historia real de implementación.',
    // Casos page — case data
    'cases.hero.text': 'Dos negocios de Elmira, NY que ya operan con MaalCa. Somos una startup local — nuestros primeros clientes son nuestros vecinos.',
    'cases.cta.profile': 'Ver perfil del negocio →',
    'cases.cta.start': 'Empieza tu implementación →',
    'cases.modules.label': 'Módulos MaalCa',
    'cases.preview.subtitle': 'Somos una startup local — nuestros primeros clientes son nuestros vecinos en Elmira, NY.',
    'cases.preview.cta': 'Ver todos los casos →',
    'cases.pegote.status': 'Activo',
    'cases.pegote.title': 'Pegote Barbershop',
    ...
    'cases.pegote.moduleStatus': 'En operación',
    'cases.pegote.module1': 'Presencia digital',
    'cases.pegote.module2': 'Catálogo de servicios',
    'cases.pegote.module3': 'Reservas online',
    'cases.tld.status': 'Activo',
    'cases.tld.title': 'Little Dominicana Restaurant',
    'cases.tld.location': '315 E Water St, Elmira NY 14901',
    'cases.tld.type': 'Restaurante',
    'cases.tld.desc': 'Restaurante dominicano en Elmira, NY — opera con MaalCa.',
    'cases.tld.moduleStatus': 'En operación',
    ...
    'docs.eyebrow': 'Así se ve en vivo',
    'docs.title': 'El producto en acción',
    'docs.description': 'Capturas reales de negocios que ya usan MaalCa — no maquetas. Así se ve tu página, tu kiosko de autopedidos, tu pantalla de menú, tu agenda y tu reloj de entrada para el equipo.',
    'docs.cta': 'Escríbenos →',
    'docs.module.page.title': 'Tu página, con tu marca',
    'docs.module.page.desc': 'Un sitio propio con tu logo, tu color y tu menú o catálogo — listo para compartir por WhatsApp o redes.',
    'docs.module.kiosk.title': 'Kiosko de autopedidos',
    'docs.module.kiosk.desc': 'El cliente arma su pedido y ve el total en tiempo real, sin que nadie lo tenga que digitar.',
    'docs.module.board.title': 'Pantalla de menú',
    'docs.module.board.desc': 'Tu menú o catálogo en una pantalla física, actualizado automáticamente cuando cambias precios.',
    'docs.module.agenda.title': 'Reservas online',
    'docs.module.agenda.desc': 'El cliente elige con quién y cuándo — sin llamadas ni mensajes de ida y vuelta.',
    'docs.module.ponche.title': 'Ponche del equipo',
    'docs.module.ponche.desc': 'Reloj de entrada y salida por PIN, con foto del empleado, directo desde una tablet o celular.',
    // Editorial
    ...
    'about.description': 'MaalCa acompaña a negocios en cada etapa de su crecimiento: organizamos tu operación, la automatizamos y sumamos inteligencia artificial donde realmente aporta valor — sin que tengas que reinventar todo desde cero cada vez que creces. Construida en Elmira, NY. Pensada para negocios como el tuyo.',
    'about.foundation': 'Origen',
    'about.foundation.desc': 'MaalCa nace como proyecto creativo: contenido, editorial y automatización de procesos.',
    'about.expansion': 'Expansión',
    'about.expansion.desc': 'Primeros proyectos de software a medida y las bases de lo que hoy son los módulos de la plataforma.',
    'about.consolidation': 'Fundación formal',
    'about.consolidation.desc': 'MaalCa LLC se constituye en Elmira, NY. Empieza el desarrollo de la plataforma actual.',    'about.platform': 'Primeros negocios',    'about.platform.desc': 'Lanzamos la plataforma con nuestros primeros clientes piloto en Elmira, NY.',
    // Projects Section
    'projects.title': 'Nuestro Ecosistema',
    'projects.description': 'Soluciones reales construidas sobre nuestra plataforma de agentes AI',
    // Individual Projects
    ...
    'project.editorial.outcome': 'Libros publicados y distribuidos globalmente',    'project.agent.title': 'MaalCa Agent Platform',    'project.agent.description': 'Orquesta agentes especializados para automatizar flujos de trabajo: desde generación de contenido hasta integraciones con sistemas externos. Enrutamiento inteligente de LLMs, colas de prioridad y control de costos en tiempo real.',    'project.agent.category': 'Plataforma SaaS · Agentes AI',    'project.agent.outcome': 'Routing multi-LLM · Colas P1–P5 · Dashboard de métricas por agente',
    ...
    // Quote Section
    'quote.philosophy': 'Automatización que trabaja mientras tú decides.',
    // Contact Section
    ...
    // Services Page - Hero
    'services.hero.title': 'Planes para cada etapa',
    'services.hero.subtitle': 'de tu negocio',
    'services.hero.description': 'Empieza gratis. Suma capacidades a tu ritmo, sin perder lo que ya construiste.',
    ...
    // Results Section
    'services.results.title': 'Empezando con resultados reales',
    'services.results.description': 'Menos de 6 meses en el mercado. Así es como medimos el progreso con nuestros primeros clientes.',
    'services.results.metric1': '2',
    'services.results.metric1.label': 'Negocios operando con MaalCa',
    'services.results.metric2': '8',
    'services.results.metric2.label': 'Módulos activos en producción',
    'services.results.metric3': '100%',
    'services.results.metric3.label': 'Transparencia: cada caso, documentado y público',
    'services.results.cta': 'Ver casos de estudio →',
    // CTA Section
    'services.cta.title': '¿Listo para hacer crecer tu negocio?',
    'services.cta.description': 'Empieza gratis hoy, o conversemos sobre qué etapa necesita tu negocio.',
    'services.cta.consultation': 'Empezar gratis',
    'services.cta.portfolio': 'Ver casos reales',
    // Contact Page - Hero
    ...
    'ciriwhispers.contacto2.facebook.title': 'Facebook',
    'ciriwhispers.contacto2.facebook.desc': 'Síguenos en Facebook para contenido exclusivo y comunidad.',
    ...
    // Kiosk (self-order) — src/app/[slug]/kiosk/KioskContent.tsx
    'kiosk.selfOrder': 'Autopedido',
    'kiosk.paymentCancelled': 'El pago se canceló. Puedes armar tu pedido de nuevo cuando quieras.',
    'kiosk.item': 'item',
    'kiosk.items': 'items',
    'kiosk.catalogUnavailable': 'El catálogo no está disponible en este momento.',
    'kiosk.all': 'Todo',
    'kiosk.viewDetails': 'Ver detalles',
    'kiosk.yourOrder': 'Tu pedido',
    'kiosk.tapToAdd': 'Toca un producto para agregarlo.',
    'kiosk.perUnit': 'c/u',
    'kiosk.removeOne': 'Quitar uno',
    'kiosk.addOne': 'Agregar uno',
    'kiosk.ingredientsHint': 'Ingredientes — destilda lo que no quieras',
    'kiosk.anythingElse': '¿Algo más? (opcional)',
    'kiosk.customizePlaceholder': 'Personalizar (ej. sin cebolla)…',
    'kiosk.yourName': 'Tu nombre (opcional)',
    'kiosk.nameForOrder': '¿A nombre de quién?',
    'kiosk.phoneOptional': 'Teléfono (opcional)',
    'kiosk.tip': 'Propina',
    'kiosk.other': 'Otro',
    'kiosk.tipAmount': 'Monto de propina',
    'kiosk.total': 'Total',
    'kiosk.redirecting': 'Redirigiendo…',
    'kiosk.addProducts': 'Agrega productos',
    'kiosk.payWithCard': 'Pagar {amount} con tarjeta',
    'kiosk.checkoutUnavailable': 'No pudimos iniciar el pago — pídele ayuda al personal.',
    'kiosk.cardPaymentUnavailable': 'El pago con tarjeta no está disponible todavía — pídele ayuda al personal para completar tu pedido.',
    'kiosk.orderReceived': '¡Pedido recibido!',
    'kiosk.paymentComplete': 'Tu pago se completó — {business} ya está preparando tu orden.',
    'kiosk.contains': 'Contiene',
    'kiosk.canRemoveIngredients': 'Puedes quitar ingredientes al agregarlo a tu pedido.',
    'kiosk.chooseSide': 'Elegir guarnición',
    'kiosk.add': 'Agregar {amount}',
    'kiosk.close': 'Cerrar',
    'kiosk.included': 'Incluido',
    'kiosk.cancel': 'Cancelar',
    // Ponche (staff time clock) — src/app/[slug]/ponche/PoncheContent.tsx
    'ponche.clockTitle': 'Reloj de entrada/salida',
    'ponche.noTeamPins': 'Ningún empleado tiene PIN configurado todavía. Pídele al dueño que te asigne uno desde el panel de Equipo.',
    'ponche.enterPin': 'Hola, {name} — escribe tu PIN',
    'ponche.cancel': 'Cancelar',
    'ponche.clockingIn': 'Ponchando…',
    'ponche.clockButton': 'Poncher',
    'ponche.welcome': '¡Bienvenido, {name}!',
    'ponche.seeYouLater': '¡Hasta luego, {name}!',
    'ponche.clockInRegistered': 'Entrada registrada.',
    'ponche.clockOutRegistered': 'Salida registrada',
    'ponche.hoursWorked': ' — {hours}h trabajadas',
    'ponche.clockError': 'No se pudo poncher.',
    // Onboarding (OnboardingForm)
    'onboarding.title': 'Crea tu espacio',
    'onboarding.subtitle': 'Unos segundos y estás en línea.',
    'onboarding.type.restaurant.label': 'Restaurante',
    'onboarding.type.restaurant.examples': 'Comida, bebidas, delivery',
    'onboarding.type.barber.label': 'Barbería',
    'onboarding.type.barber.examples': 'Cortes, salones de belleza, spa',
    'onboarding.type.service.label': 'Servicios',
    'onboarding.type.service.examples': 'Consultoría, talleres, profesionales',
    'onboarding.type.retail.label': 'Tienda',
    'onboarding.type.retail.examples': 'Ropa, ferretería, regalos, artículos varios',
    'onboarding.type.community.label': 'Comunidad',
    'onboarding.type.community.examples': 'Comedores, bancos de alimentos, causas comunitarias',
    'onboarding.type.creator.label': 'Creador',
    'onboarding.type.publisher.label': 'Editorial',
    'onboarding.type.professional.label': 'Profesional',
    'onboarding.type.comingSoonTitle': 'Próximamente',
    'onboarding.type.comingSoonBadge': 'Pronto',
    'onboarding.palette.blueMaalca': 'Azul MaalCa',
    'onboarding.palette.redMaalca': 'Rojo',
    'onboarding.palette.oceanBlue': 'Azul Océano',
    'onboarding.palette.emeraldGreen': 'Verde Esmeralda',
    'onboarding.palette.purple': 'Morado',
    'onboarding.palette.orange': 'Naranja',
    'onboarding.palette.pink': 'Rosa',
    'onboarding.palette.yellow': 'Amarillo',
    'onboarding.palette.turquoise': 'Turquesa',
    'onboarding.palette.black': 'Negro',
    'onboarding.palette.slateGray': 'Gris Pizarra',
    'onboarding.palette.brown': 'Café',
    'onboarding.palette.indigo': 'Índigo',
    'onboarding.error.logoTooLarge': 'La imagen no puede superar 2MB.',
    'onboarding.error.duplicateBusiness': 'Ya tienes un negocio. Upgrade a Entrepreneur para crear más de uno.',
    'onboarding.error.generic': 'Algo salió mal. Intenta de nuevo.',
    'onboarding.step.name.label': 'Nombre del negocio',
    'onboarding.step.name.placeholder': 'Ej. La Casa del Mofongo',
    'onboarding.step.type.label': '¿Qué tipo de negocio?',
    'onboarding.step.color.label': 'Color principal',
    'onboarding.step.logo.label': 'Logo (opcional)',
    'onboarding.step.logo.title': 'Subir logo',
    'onboarding.step.logo.hint': 'Puedes agregarlo después si prefieres.',
    'onboarding.step.whatsapp.label': 'WhatsApp (opcional)',
    'onboarding.step.whatsapp.hint1': 'Tus clientes te escribirán directamente a este número.',
    'onboarding.step.whatsapp.hint2': 'Incluye el código de país (1 para República Dominicana/Estados Unidos).',
    'onboarding.step.whatsapp.invalid': 'El número de WhatsApp debe incluir el código de país (ej. 1 para RD/USA): 18095551234',
    'onboarding.button.back': 'Atrás',
    'onboarding.button.creating': 'Creando...',
    'onboarding.button.create': 'Crear mi espacio',
    'onboarding.button.next': 'Siguiente',
    // Casos de Estudio (public case studies page)
    'casosEstudio.hero.titleLine1': 'Casos de',
    'casosEstudio.hero.titleLine2': 'Estudio',
    'casosEstudio.hero.subtitle': 'Análisis profundos de nuestros proyectos: desafíos enfrentados, soluciones implementadas y resultados medibles que demuestran el impacto real del ecosistema MaalCa.',
    'casosEstudio.hero.casesAnalyzed': 'Casos Analizados',
    'casosEstudio.hero.verticals': 'Verticales de Negocio',
    'casosEstudio.hero.resultsPrefix': 'Resultados',
    'casosEstudio.hero.resultsVerifiable': 'Verificables',
    'casosEstudio.section.challenge': '🎯 Desafío',
    'casosEstudio.section.solution': '💡 Solución',
    'casosEstudio.section.metrics': '📊 Métricas Clave',
    'casosEstudio.section.technologies': 'Tecnologías y Enfoques:',
    'casosEstudio.section.results': '🏆 Resultados Clave',
    'casosEstudio.cta.heading': '¿Tu proyecto será el próximo caso de estudio?',
    'casosEstudio.cta.paragraph': 'Cada proyecto del ecosistema MaalCa comienza con una idea audaz y se convierte en una solución medible. Conversemos sobre tu visión.',
    'casosEstudio.cta.startProject': 'Iniciar Tu Proyecto',
    'casosEstudio.cta.ourServices': 'Ver Nuestros Servicios',
    'casosEstudio.editorial.title': 'Editorial MaalCa: Filosofía Digital Global',
    'casosEstudio.editorial.category': 'Editorial + KDP',
    'casosEstudio.editorial.challenge': 'Crear una editorial que pudiera competir globalmente desde República Dominicana',
    'casosEstudio.editorial.solution': 'Distribución digital via Amazon KDP con enfoque en filosofía contemporánea caribeña',
    'casosEstudio.editorial.results.books': '3 libros publicados',
    'casosEstudio.editorial.results.reach': 'Disponible en 200+ países',
    'casosEstudio.editorial.results.sales': 'Ventas constantes internacionales',
    'casosEstudio.editorial.results.impact': 'Primera editorial dominicana en filosofía digital',
    'casosEstudio.editorial.metrics.launchTime': 'Tiempo de lanzamiento',
    'casosEstudio.editorial.metrics.countriesReached': 'Países alcanzados',
    'casosEstudio.editorial.metrics.distributionCost': 'Costo de distribución',
    'casosEstudio.editorial.metrics.globalReach': 'Alcance global',
    'casosEstudio.editorial.testimonial.text': 'La estrategia digital nos permitió competir globalmente sin las limitaciones tradicionales de la industria editorial',
    'casosEstudio.editorial.testimonial.author': 'Equipo Editorial MaalCa',
    'casosEstudio.ciriwhispers.title': 'CiriWhispers: Narrativas Íntimas Digitales',
    'casosEstudio.ciriwhispers.category': 'Autor + Escritor Creativo',
    'casosEstudio.ciriwhispers.challenge': 'Crear conexiones auténticas en un mundo digital saturado',
    'casosEstudio.ciriwhispers.solution': 'Narrativas personales profundas con sistema bilingüe y engagement genuino',
    'casosEstudio.ciriwhispers.results.engagement': '85% tasa de engagement',
    'casosEstudio.ciriwhispers.results.retention': 'Audiencia fiel y creciente',
    'casosEstudio.ciriwhispers.results.books': '2 novelas publicadas',
    'casosEstudio.ciriwhispers.results.community': 'Comunidad global activa',
    'casosEstudio.ciriwhispers.metrics.engagementRate': 'Engagement Rate',
    'casosEstudio.ciriwhispers.metrics.readingTime': 'Tiempo de lectura',
    'casosEstudio.ciriwhispers.metrics.audienceRetention': 'Retención de audiencia',
    'casosEstudio.ciriwhispers.metrics.monthlyGrowth': 'Crecimiento mensual',
    'casosEstudio.ciriwhispers.testimonial.text': 'La autenticidad y profundidad de las narrativas crearon una conexión real con lectores globales',
    'casosEstudio.ciriwhispers.testimonial.author': 'Ciriaco A. Pichardo',
    'casosEstudio.masaTina.title': 'Cocina Tina: Gastronomía Digital Dominicana',
    'casosEstudio.masaTina.category': 'Catálogo + POS + Stripe',
    'casosEstudio.masaTina.challenge': 'Digitalizar experiencias gastronómicas tradicionales dominicanas',
    'casosEstudio.masaTina.solution': 'Plataforma completa con catálogo, POS y procesamiento de pagos integrado',
    'casosEstudio.masaTina.results.orders': '500+ pedidos mensuales',
    'casosEstudio.masaTina.results.efficiency': 'Operaciones 70% más eficientes',
    'casosEstudio.masaTina.results.revenue': 'Ingresos incrementados 200%',
    'casosEstudio.masaTina.results.satisfaction': '98% satisfacción del cliente',
    'casosEstudio.masaTina.metrics.monthlyOrders': 'Pedidos mensuales',
    'casosEstudio.masaTina.metrics.processingTime': 'Tiempo de procesamiento',
    'casosEstudio.masaTina.metrics.revenueIncrease': 'Incremento de ingresos',
    'casosEstudio.masaTina.metrics.customerSatisfaction': 'Satisfacción cliente',
    'casosEstudio.masaTina.testimonial.text': 'La digitalización preservó la esencia de nuestra cocina tradicional mientras modernizó completamente el negocio',
    'casosEstudio.masaTina.testimonial.author': 'Equipo Cocina Tina',
    'casosEstudio.hbmPodcast.title': 'Hablando Mierda: Filosofía Sin Filtros',
    'casosEstudio.hbmPodcast.category': 'Podcast + Media',
    'casosEstudio.hbmPodcast.challenge': 'Crear contenido auténtico que resonara con audiencias diversas',
    'casosEstudio.hbmPodcast.solution': 'Conversaciones sin censura con filosofía callejera y sentido humano',
    'casosEstudio.hbmPodcast.results.episodes': '50+ episodios publicados',
    'casosEstudio.hbmPodcast.results.downloads': '10K+ descargas mensuales',
    'casosEstudio.hbmPodcast.results.community': 'Comunidad activa y comprometida',
    'casosEstudio.hbmPodcast.results.monetization': 'Monetización por episodio exitosa',
    'casosEstudio.hbmPodcast.metrics.episodesPublished': 'Episodios publicados',
    'casosEstudio.hbmPodcast.metrics.monthlyDownloads': 'Descargas mensuales',
    'casosEstudio.hbmPodcast.metrics.avgEngagement': 'Engagement promedio',
    'casosEstudio.hbmPodcast.metrics.audienceGrowth': 'Crecimiento audiencia',
    'casosEstudio.hbmPodcast.testimonial.text': 'La autenticidad y las conversaciones reales crearon una comunidad que trasciende el formato digital',
    'casosEstudio.hbmPodcast.testimonial.author': 'Oyente Regular HBM',
    'casosEstudio.verdePrive.title': 'Verde Privé: Cannabis Premium Discreto',
    'casosEstudio.verdePrive.category': 'Cannabis + Lifestyle',
    'casosEstudio.verdePrive.challenge': 'Crear una marca premium de cannabis con máxima discreción y calidad',
    'casosEstudio.verdePrive.solution': 'Lifestyle brand enfocado en bienestar adulto consciente con privacidad garantizada',
    'casosEstudio.verdePrive.results.launch': 'Lanzamiento Q1 2025',
    'casosEstudio.verdePrive.results.positioning': 'Posicionamiento premium establecido',
    'casosEstudio.verdePrive.results.privacy': 'Sistema de privacidad implementado',
    'casosEstudio.verdePrive.results.quality': 'Estándares artesanales definidos',
    'casosEstudio.verdePrive.metrics.launchPrep': 'Preparación de lanzamiento',
    'casosEstudio.verdePrive.metrics.productDevelopment': 'Desarrollo de producto',
    'casosEstudio.verdePrive.metrics.privacySystem': 'Sistema de privacidad',
    'casosEstudio.verdePrive.metrics.premiumPositioning': 'Posicionamiento premium',
    'casosEstudio.verdePrive.testimonial.text': 'Combinar calidad artesanal con discreción total redefine la experiencia del cannabis premium',
    'casosEstudio.verdePrive.testimonial.author': 'Equipo Desarrollo Verde Privé',
    'casosEstudio.maalcaProperties.title': 'MaalCa Properties: Inversión Turística Global',
    'casosEstudio.maalcaProperties.category': 'Turismo + Real Estate',
    'casosEstudio.maalcaProperties.challenge': 'Conectar inversores globales con propiedades turísticas dominicanas',
    'casosEstudio.maalcaProperties.solution': 'Plataforma especializada en propiedades frente al océano con gestión completa',
    'casosEstudio.maalcaProperties.results.properties': '25+ propiedades gestionadas',
    'casosEstudio.maalcaProperties.results.investors': 'Inversores de 15 países',
    'casosEstudio.maalcaProperties.results.roi': 'ROI promedio 18% anual',
    'casosEstudio.maalcaProperties.results.satisfaction': '100% satisfacción inversores',
    'casosEstudio.maalcaProperties.metrics.activeProperties': 'Propiedades activas',
    'casosEstudio.maalcaProperties.metrics.investorCountries': 'Países de inversores',
    'casosEstudio.maalcaProperties.metrics.avgRoi': 'ROI promedio anual',
    'casosEstudio.maalcaProperties.metrics.investorSatisfaction': 'Satisfacción inversores',
    'casosEstudio.maalcaProperties.testimonial.text': 'La expertise local combinada con visión internacional hizo realidad nuestras inversiones en el Caribe',
    'casosEstudio.maalcaProperties.testimonial.author': 'Inversor Internacional',
  },
  en: {
    // Auth nav
    'auth.login': 'Log in',
    ...
    'home.hero.title2': 'You need your',
    'home.hero.titleHighlight': 'digital space',
    'home.hero.subtitle': "Create, customize, publish, and manage your business's digital space. No code. No generic templates.",
    'home.hero.ctaPrimary': 'Create my space for free',
    'home.hero.ctaSecondary': 'See real examples →',
    'home.hero.mockupAlt': "Modules panel of an affiliate's digital space in MaalCa",
    'home.showcase.heading': 'Real businesses, real spaces',
    'home.showcase.subtitle': 'No mockups — this is what they look like today in production',
    'home.showcase.footnote': "Retail (BritoColor) joins once its catalog is published — we don't show mockups as if they were real.",
    'home.showcase.prevImage': 'Previous image',
    'home.showcase.nextImage': 'Next image',
    'home.showcase.viewImage': 'View image',
    'home.showcase.zoomImage': 'Zoom image',
    'home.showcase.close': 'Close',
    'home.showcase.pegote.pill': 'Barbershop — Pegote',
    'home.showcase.pegote.category': 'BARBERSHOP',
    'home.showcase.pegote.description': 'Dynamic template already live in production — bookings, service catalog, and business profile, all from one space.',
    'home.showcase.pegote.img.waitingQueue': "Pegote Barbershop's real-time waiting queue in MaalCa",
    'home.showcase.pegote.img.screenBoard': 'Public screen with the queue and service menu of Pegote Barbershop in MaalCa',
    'home.showcase.pegote.img.agenda': "Pegote Barbershop's appointment schedule by barber in MaalCa",
    'home.showcase.pegote.img.booking': "Public booking page with Pegote Barbershop's barber team in MaalCa",
    'home.showcase.pegote.img.branding': 'Brand and digital space customization for Pegote Barbershop in MaalCa',
    'home.showcase.littleDominican.pill': 'Restaurant — The Little Dominican',
    'home.showcase.littleDominican.category': 'RESTAURANT',
    'home.showcase.littleDominican.description': 'Menu, modifiers, and orders managed from the same panel — no generic templates for a real restaurant.',
    'home.showcase.littleDominican.img.kitchen': "The Little Dominican's kitchen display screen (KDS) in MaalCa",
    'home.showcase.littleDominican.img.pos': "The Little Dominican's point of sale in MaalCa",
    'home.showcase.littleDominican.img.catalog': "The Little Dominican's catalog / menu in MaalCa",
    'home.showcase.littleDominican.img.orders': "The Little Dominican's orders in MaalCa",
    'home.showcase.littleDominican.img.dashboard': "The Little Dominican's main dashboard in MaalCa",
    'home.showcase.littleDominican.img.stats': "The Little Dominican's stats in MaalCa",
    'home.showcase.littleDominican.img.qrCard': "The Little Dominican's QR code and business card in MaalCa",
    'home.steps.heading': 'This simple',
    'home.steps.1': 'Create your space',
    'home.steps.2': 'Customize your brand',
    'home.steps.3': 'Publish in one click',
    'home.steps.4': 'Manage everything from there',
    'home.cta.heading': 'Ready to get your digital space?',
    'home.cta.subtitle': 'No credit card required. Publish today.',
    // Navigation
    'nav.home': 'Home',
    ...
    'footer.product.platform': 'Platform',
    'footer.product.cases': 'Cases',
    ...
    // Homepage Hero
    'hero.maalca': 'We grow your business,',
    'hero.ecosystem': 'one stage at a time.',
        'hero.subtitle': 'MaalCa gets you online in minutes — catalog, contact channels, and your own page, no code needed. Start free.',
    'hero.eyebrow': 'DIGITAL TRANSFORMATION FOR BUSINESSES',
    'hero.cta.projects': 'Start free — no card required',
    'hero.cta.join': 'See how it works',
    // Ecosystem Section
    ...
    // Affiliates Section
    'affiliates.title': 'Businesses that trust us',
    'affiliates.description': 'Real clients with physical presence in our community',
    'cases.title': 'Businesses already running on MaalCa',
    'platform.title': 'Capabilities that turn on when you need them',
    'platform.subtitle': 'Modules that work together, not in silos — you add more as your business grows.',
    ...
    'platform.mod.analytics': 'Analytics',
    'platform.mod.analytics.desc': 'Dashboard with visits, QR scans, and clicks by channel.',
    'platform.mod.identity': 'Brand identity',
    'platform.mod.identity.desc': 'QR in your color, downloadable business card, ready to share on WhatsApp.',
    ...
    'how.title': "Here's how you move forward, step by step",    'how.subtitle': 'From first conversation to a business up and running — no friction, no code.',
    'how.step1.title': 'Create your account',
    'how.step1.desc': 'Sign in with Google. No calls, no waiting on anyone.',
    'how.step2.title': 'Build your space',
    'how.step2.desc': 'Name, business type, color, logo, and contact channels. You, in minutes.',
    'how.step3.title': 'Fill in your catalog and channels',
    'how.step3.desc': 'Products, services, or menu, with real photos and prices. WhatsApp, social, hours — everything your customers need to know.',
    'how.step4.title': 'Share your QR and track results',
    'how.step4.desc': "Your QR code, link, and business card, ready to share. Real-time stats dashboard so you know what's working.",
    'pricing.title': 'Plans for every stage',
    'pricing.subtitle': 'Start free and add capabilities at your own pace, without losing what you\'ve already built.',
    'pricing.plan.cta': 'View full plan →',
    ...
    'cta.final.subtitle': 'Your first page, catalog and QR code: free forever. You add the rest when your business is ready for it.',
    'cta.final.btn': 'Create my free account →',    'beyond.title': 'Beyond business',    'beyond.subtitle': 'MaalCa is also a publisher and a literary voice.',    'beyond.editorial.title': 'Editorial MaalCa',    'beyond.editorial.desc': 'We publish books at a fair price, or free if the work moves us to give it away.',    'beyond.editorial.cta': 'Discover the editorial →',    'beyond.ciri.title': 'CiriWhispers',    'beyond.ciri.desc': 'The founder\'s literary space. Fiction, poetry and letters. Human writing, no algorithms.',    'beyond.ciri.cta': 'Read →',    'editorial.hero.eyebrow': 'Independent editorial',    'editorial.hero.title': 'Publishing your book shouldn\'t cost you your savings.',    'editorial.hero.subtitle': 'It also shouldn\'t depend on someone with power saying yes. At Editorial MaalCa we do both: we help you publish at a fair price, or if it moves us, we publish it without charging you.',    'editorial.hero.cta.primary': 'Publish with us',    'editorial.hero.cta.secondary': 'See catalog',    'editorial.tracks.title': 'Two ways to publish',    'editorial.track.assisted.title': 'Assisted Track',    'editorial.track.assisted.price': '$185 USD',    'editorial.track.assisted.subtitle': 'For those with a finished work',    'editorial.track.curated.title': 'Curated Track',    'editorial.track.curated.price': 'Free',    'editorial.track.curated.subtitle': 'For works that move us',    'editorial.tech.title': 'Technology that reduces cost. Curation that matters.',    'editorial.tech.ai.title': 'What we automate',    'editorial.tech.human.title': 'What we do NOT automate',    'casos.title': 'Real implementations',    'casos.subtitle': 'REAL BUSINESSES. HONEST RESULTS.',    'casos.coming': 'COMING SOON',    'casos.coming.desc': 'We are adding more businesses. Every client is a real implementation story.',
    'cases.hero.text': "Two businesses in Elmira, NY already running on MaalCa. We're a local startup — our first clients are our neighbors.",
    'cases.cta.profile': 'View business profile →',
    'cases.cta.start': 'Start your implementation →',
    'cases.modules.label': 'MaalCa modules',
    'cases.preview.subtitle': "We're a local startup — our first clients are our neighbors in Elmira, NY.",
    'cases.preview.cta': 'View all case studies →',
    'cases.pegote.status': 'Active',
    'cases.pegote.title': 'Pegote Barbershop',
    'cases.pegote.location': 'Elmira, NY',
    'cases.pegote.type': 'Barbershop',
    'cases.pegote.desc': 'Dominican barbershop in Elmira, NY — MaalCa\'s first pilot client.',
    'cases.pegote.moduleStatus': 'Live',
    'cases.pegote.module1': 'Digital presence',
    'cases.pegote.module2': 'Service catalog',
    'cases.pegote.module3': 'Online bookings',
    'cases.tld.status': 'Active',
    'cases.tld.title': 'Little Dominicana Restaurant',
    'cases.tld.location': '315 E Water St, Elmira NY 14901',
    'cases.tld.type': 'Restaurant',
    'cases.tld.desc': 'Dominican restaurant in Elmira, NY — running on MaalCa.',
    'cases.tld.moduleStatus': 'Live',
    'cases.tld.module1': 'Digital catalog with QR',
    'cases.tld.module2': 'Online ordering',
    ...
    'docs.eyebrow': 'This is live',
    'docs.title': 'The product in action',
    'docs.description': "Real screenshots from businesses already using MaalCa — not mockups. This is what your page, self-order kiosk, menu screen, booking flow and staff clock-in actually look like.",
    'docs.cta': 'Contact us →',
    'docs.module.page.title': 'Your page, your brand',
    'docs.module.page.desc': 'A site of your own with your logo, your color, and your menu or catalog — ready to share on WhatsApp or social.',
    'docs.module.kiosk.title': 'Self-order kiosk',
    'docs.module.kiosk.desc': 'Customers build their own order and see the total update live, no one has to type it in.',
    'docs.module.board.title': 'Menu screen',
    'docs.module.board.desc': 'Your menu or catalog on a physical screen, updated automatically whenever you change a price.',
    'docs.module.agenda.title': 'Online booking',
    'docs.module.agenda.desc': 'Customers pick who and when — no calls or back-and-forth messages.',
    'docs.module.ponche.title': 'Staff clock-in',
    'docs.module.ponche.desc': 'PIN-based clock in/out with employee photo, right from a tablet or phone.',
    // Editorial
    ...
    'about.description': 'MaalCa supports businesses through every stage of growth: we organize your operations, automate them, and add artificial intelligence where it truly adds value — without making you rebuild everything from scratch each time you grow. Built in Elmira, NY. Made for businesses like yours.',
    'about.foundation': 'Origin',
    'about.foundation.desc': 'MaalCa begins as a creative project: content, editorial work and process automation.',
    'about.expansion': 'Expansion',
    'about.expansion.desc': "First custom software projects, laying the groundwork for today's platform modules.",
    'about.consolidation': 'Formal founding',
    'about.consolidation.desc': 'MaalCa LLC is established in Elmira, NY. Development of the current platform begins.',    'about.platform': 'First businesses',    'about.platform.desc': 'We launch the platform with our first pilot clients in Elmira, NY.',    // Projects Section
    'projects.title': 'Our Ecosystem',
    'projects.description': 'Real solutions built on our AI agent orchestration platform',
    // Individual Projects
    ...
    'project.editorial.category': 'Editorial + KDP',
    'project.editorial.outcome': 'Books published and distributed globally',    'project.agent.title': 'MaalCa Agent Platform',    'project.agent.description': 'Orchestrate specialized agents to automate workflows: from content generation to external system integrations. Intelligent LLM routing, priority queues and real-time cost control per agent.',    'project.agent.category': 'SaaS Platform · AI Agents',    'project.agent.outcome': 'Multi-LLM routing · P1–P5 queues · Per-agent metrics dashboard',
    'project.ciriwhispers.title': 'CiriWhispers',
    ...
    // Quote Section
    'quote.philosophy': 'Automation that works while you decide.',
    // Contact Section
    ...
    // Services Page - Hero
    'services.hero.title': 'Plans for every stage',
    'services.hero.subtitle': 'of your business',
    'services.hero.description': "Start free. Add capabilities at your own pace, without losing what you've already built.",
    // Services Page - Services Section
    ...
    // Results Section
    'services.results.title': 'Starting with real results',
    'services.results.description': "Less than 6 months in the market. Here's how we track progress with our first clients.",
    'services.results.metric1': '2',
    'services.results.metric1.label': 'Businesses running on MaalCa',
    'services.results.metric2': '8',
    'services.results.metric2.label': 'Modules live in production',
    'services.results.metric3': '100%',
    'services.results.metric3.label': 'Transparency: every case, documented and public',
    'services.results.cta': 'View case studies →',
    // CTA Section
    'services.cta.title': 'Ready to grow your business?',
    'services.cta.description': "Start free today, or let's talk about what stage your business needs.",
    'services.cta.consultation': 'Start free',
    'services.cta.portfolio': 'See real cases',
    // Contact Page - Hero
    ...
    'ciriwhispers.contacto2.facebook.title': 'Facebook',
    'ciriwhispers.contacto2.facebook.desc': 'Follow us on Facebook for exclusive content and community.',
    ...
    // Kiosk (self-order) — src/app/[slug]/kiosk/KioskContent.tsx
    'kiosk.selfOrder': 'Self-order',
    'kiosk.paymentCancelled': "Payment was cancelled. You can build your order again whenever you're ready.",
    'kiosk.item': 'item',
    'kiosk.items': 'items',
    'kiosk.catalogUnavailable': "The catalog isn't available right now.",
    'kiosk.all': 'All',
    'kiosk.viewDetails': 'View details',
    'kiosk.yourOrder': 'Your order',
    'kiosk.tapToAdd': 'Tap a product to add it.',
    'kiosk.perUnit': 'each',
    'kiosk.removeOne': 'Remove one',
    'kiosk.addOne': 'Add one',
    'kiosk.ingredientsHint': "Ingredients — uncheck what you don't want",
    'kiosk.anythingElse': 'Anything else? (optional)',
    'kiosk.customizePlaceholder': 'Customize (e.g. no onion)…',
    'kiosk.yourName': 'Your name (optional)',
    'kiosk.nameForOrder': 'What name should we use?',
    'kiosk.phoneOptional': 'Phone (optional)',
    'kiosk.tip': 'Tip',
    'kiosk.other': 'Other',
    'kiosk.tipAmount': 'Tip amount',
    'kiosk.total': 'Total',
    'kiosk.redirecting': 'Redirecting…',
    'kiosk.addProducts': 'Add products',
    'kiosk.payWithCard': 'Pay {amount} with card',
    'kiosk.checkoutUnavailable': "We couldn't start checkout — ask staff for help.",
    'kiosk.cardPaymentUnavailable': "Card payment isn't available yet — ask staff for help completing your order.",
    'kiosk.orderReceived': 'Order received!',
    'kiosk.paymentComplete': 'Your payment went through — {business} is already preparing your order.',
    'kiosk.contains': 'Contains',
    'kiosk.canRemoveIngredients': 'You can remove ingredients when you add it to your order.',
    'kiosk.chooseSide': 'Choose a side',
    'kiosk.add': 'Add {amount}',
    'kiosk.close': 'Close',
    'kiosk.included': 'Included',
    'kiosk.cancel': 'Cancel',
    // Ponche (staff time clock) — src/app/[slug]/ponche/PoncheContent.tsx
    'ponche.clockTitle': 'Time clock',
    'ponche.noTeamPins': 'No employees have a PIN set up yet. Ask the owner to assign you one from the Team panel.',
    'ponche.enterPin': 'Hi, {name} — enter your PIN',
    'ponche.cancel': 'Cancel',
    'ponche.clockingIn': 'Clocking in…',
    'ponche.clockButton': 'Clock in/out',
    'ponche.welcome': 'Welcome, {name}!',
    'ponche.seeYouLater': 'See you later, {name}!',
    'ponche.clockInRegistered': 'Clock-in recorded.',
    'ponche.clockOutRegistered': 'Clock-out recorded',
    'ponche.hoursWorked': ' — {hours}h worked',
    'ponche.clockError': "Couldn't clock in/out.",
    // Onboarding (OnboardingForm)
    'onboarding.title': 'Create your space',
    'onboarding.subtitle': "A few seconds and you're live.",
    'onboarding.type.restaurant.label': 'Restaurant',
    'onboarding.type.restaurant.examples': 'Food, drinks, delivery',
    'onboarding.type.barber.label': 'Barbershop',
    'onboarding.type.barber.examples': 'Haircuts, beauty salons, spa',
    'onboarding.type.service.label': 'Services',
    'onboarding.type.service.examples': 'Consulting, workshops, professionals',
    'onboarding.type.retail.label': 'Shop',
    'onboarding.type.retail.examples': 'Clothing, hardware, gifts, general goods',
    'onboarding.type.community.label': 'Community',
    'onboarding.type.community.examples': 'Soup kitchens, food banks, community causes',
    'onboarding.type.creator.label': 'Creator',
    'onboarding.type.publisher.label': 'Publisher',
    'onboarding.type.professional.label': 'Professional',
    'onboarding.type.comingSoonTitle': 'Coming soon',
    'onboarding.type.comingSoonBadge': 'Soon',
    'onboarding.palette.blueMaalca': 'MaalCa Blue',
    'onboarding.palette.redMaalca': 'Red',
    'onboarding.palette.oceanBlue': 'Ocean Blue',
    'onboarding.palette.emeraldGreen': 'Emerald Green',
    'onboarding.palette.purple': 'Purple',
    'onboarding.palette.orange': 'Orange',
    'onboarding.palette.pink': 'Pink',
    'onboarding.palette.yellow': 'Yellow',
    'onboarding.palette.turquoise': 'Turquoise',
    'onboarding.palette.black': 'Black',
    'onboarding.palette.slateGray': 'Slate Gray',
    'onboarding.palette.brown': 'Brown',
    'onboarding.palette.indigo': 'Indigo',
    'onboarding.error.logoTooLarge': "The image can't be over 2MB.",
    'onboarding.error.duplicateBusiness': 'You already have a business. Upgrade to Entrepreneur to create more than one.',
    'onboarding.error.generic': 'Something went wrong. Try again.',
    'onboarding.step.name.label': 'Business name',
    'onboarding.step.name.placeholder': 'E.g. La Casa del Mofongo',
    'onboarding.step.type.label': 'What type of business?',
    'onboarding.step.color.label': 'Main color',
    'onboarding.step.logo.label': 'Logo (optional)',
    'onboarding.step.logo.title': 'Upload logo',
    'onboarding.step.logo.hint': "You can add it later if you'd rather.",
    'onboarding.step.whatsapp.label': 'WhatsApp (optional)',
    'onboarding.step.whatsapp.hint1': 'Your customers will message you directly at this number.',
    'onboarding.step.whatsapp.hint2': 'Include the country code (1 for the Dominican Republic/United States).',
    'onboarding.step.whatsapp.invalid': 'The WhatsApp number must include the country code (e.g. 1 for DR/USA): 18095551234',
    'onboarding.button.back': 'Back',
    'onboarding.button.creating': 'Creating...',
    'onboarding.button.create': 'Create my space',
    'onboarding.button.next': 'Next',
    // Casos de Estudio (public case studies page)
    'casosEstudio.hero.titleLine1': 'Case',
    'casosEstudio.hero.titleLine2': 'Studies',
    'casosEstudio.hero.subtitle': "A deep look at our projects: challenges we faced, solutions we built, and measurable results that show the real impact of the MaalCa ecosystem.",
    'casosEstudio.hero.casesAnalyzed': 'Cases Analyzed',
    'casosEstudio.hero.verticals': 'Business Verticals',
    'casosEstudio.hero.resultsPrefix': 'Results',
    'casosEstudio.hero.resultsVerifiable': 'Verifiable',
    'casosEstudio.section.challenge': '🎯 Challenge',
    'casosEstudio.section.solution': '💡 Solution',
    'casosEstudio.section.metrics': '📊 Key Metrics',
    'casosEstudio.section.technologies': 'Technologies & Approaches:',
    'casosEstudio.section.results': '🏆 Key Results',
    'casosEstudio.cta.heading': 'Will your project be the next case study?',
    'casosEstudio.cta.paragraph': "Every project in the MaalCa ecosystem starts as a bold idea and becomes a measurable solution. Let's talk about your vision.",
    'casosEstudio.cta.startProject': 'Start Your Project',
    'casosEstudio.cta.ourServices': 'See Our Services',
    'casosEstudio.editorial.title': 'Editorial MaalCa: Global Digital Philosophy',
    'casosEstudio.editorial.category': 'Publishing + KDP',
    'casosEstudio.editorial.challenge': 'Build a publishing house that could compete globally from the Dominican Republic',
    'casosEstudio.editorial.solution': 'Digital distribution via Amazon KDP focused on contemporary Caribbean philosophy',
    'casosEstudio.editorial.results.books': '3 books published',
    'casosEstudio.editorial.results.reach': 'Available in 200+ countries',
    'casosEstudio.editorial.results.sales': 'Steady international sales',
    'casosEstudio.editorial.results.impact': 'First Dominican publisher in digital philosophy',
    'casosEstudio.editorial.metrics.launchTime': 'Launch time',
    'casosEstudio.editorial.metrics.countriesReached': 'Countries reached',
    'casosEstudio.editorial.metrics.distributionCost': 'Distribution cost',
    'casosEstudio.editorial.metrics.globalReach': 'Global reach',
    'casosEstudio.editorial.testimonial.text': 'The digital strategy let us compete globally without the traditional limits of the publishing industry',
    'casosEstudio.editorial.testimonial.author': 'Editorial MaalCa Team',
    'casosEstudio.ciriwhispers.title': 'CiriWhispers: Intimate Digital Narratives',
    'casosEstudio.ciriwhispers.category': 'Author + Creative Writer',
    'casosEstudio.ciriwhispers.challenge': 'Build authentic connections in a saturated digital world',
    'casosEstudio.ciriwhispers.solution': 'Deep personal narratives with a bilingual system and genuine engagement',
    'casosEstudio.ciriwhispers.results.engagement': '85% engagement rate',
    'casosEstudio.ciriwhispers.results.retention': 'Loyal, growing audience',
    'casosEstudio.ciriwhispers.results.books': '2 novels published',
    'casosEstudio.ciriwhispers.results.community': 'Active global community',
    'casosEstudio.ciriwhispers.metrics.engagementRate': 'Engagement Rate',
    'casosEstudio.ciriwhispers.metrics.readingTime': 'Reading time',
    'casosEstudio.ciriwhispers.metrics.audienceRetention': 'Audience retention',
    'casosEstudio.ciriwhispers.metrics.monthlyGrowth': 'Monthly growth',
    'casosEstudio.ciriwhispers.testimonial.text': 'The authenticity and depth of the narratives created a real connection with readers worldwide',
    'casosEstudio.ciriwhispers.testimonial.author': 'Ciriaco A. Pichardo',
    'casosEstudio.masaTina.title': 'Cocina Tina: Digital Dominican Gastronomy',
    'casosEstudio.masaTina.category': 'Catalog + POS + Stripe',
    'casosEstudio.masaTina.challenge': 'Digitize traditional Dominican dining experiences',
    'casosEstudio.masaTina.solution': 'Full platform with catalog, POS, and integrated payment processing',
    'casosEstudio.masaTina.results.orders': '500+ orders per month',
    'casosEstudio.masaTina.results.efficiency': 'Operations 70% more efficient',
    'casosEstudio.masaTina.results.revenue': 'Revenue up 200%',
    'casosEstudio.masaTina.results.satisfaction': '98% customer satisfaction',
    'casosEstudio.masaTina.metrics.monthlyOrders': 'Monthly orders',
    'casosEstudio.masaTina.metrics.processingTime': 'Processing time',
    'casosEstudio.masaTina.metrics.revenueIncrease': 'Revenue increase',
    'casosEstudio.masaTina.metrics.customerSatisfaction': 'Customer satisfaction',
    'casosEstudio.masaTina.testimonial.text': 'Going digital kept the soul of our traditional kitchen while fully modernizing the business',
    'casosEstudio.masaTina.testimonial.author': 'Cocina Tina Team',
    'casosEstudio.hbmPodcast.title': 'Hablando Mierda: Philosophy Without Filters',
    'casosEstudio.hbmPodcast.category': 'Podcast + Media',
    'casosEstudio.hbmPodcast.challenge': 'Create authentic content that resonates with diverse audiences',
    'casosEstudio.hbmPodcast.solution': 'Uncensored conversations with street philosophy and common sense',
    'casosEstudio.hbmPodcast.results.episodes': '50+ episodes published',
    'casosEstudio.hbmPodcast.results.downloads': '10K+ downloads per month',
    'casosEstudio.hbmPodcast.results.community': 'Active, engaged community',
    'casosEstudio.hbmPodcast.results.monetization': 'Successful per-episode monetization',
    'casosEstudio.hbmPodcast.metrics.episodesPublished': 'Episodes published',
    'casosEstudio.hbmPodcast.metrics.monthlyDownloads': 'Monthly downloads',
    'casosEstudio.hbmPodcast.metrics.avgEngagement': 'Average engagement',
    'casosEstudio.hbmPodcast.metrics.audienceGrowth': 'Audience growth',
    'casosEstudio.hbmPodcast.testimonial.text': 'The authenticity and real conversations built a community that goes beyond the digital format',
    'casosEstudio.hbmPodcast.testimonial.author': 'Regular HBM Listener',
    'casosEstudio.verdePrive.title': 'Verde Privé: Discreet Premium Cannabis',
    'casosEstudio.verdePrive.category': 'Cannabis + Lifestyle',
    'casosEstudio.verdePrive.challenge': 'Build a premium cannabis brand with maximum discretion and quality',
    'casosEstudio.verdePrive.solution': 'A lifestyle brand focused on mindful adult wellness with guaranteed privacy',
    'casosEstudio.verdePrive.results.launch': 'Q1 2025 launch',
    'casosEstudio.verdePrive.results.positioning': 'Premium positioning established',
    'casosEstudio.verdePrive.results.privacy': 'Privacy system implemented',
    'casosEstudio.verdePrive.results.quality': 'Artisanal standards defined',
    'casosEstudio.verdePrive.metrics.launchPrep': 'Launch preparation',
    'casosEstudio.verdePrive.metrics.productDevelopment': 'Product development',
    'casosEstudio.verdePrive.metrics.privacySystem': 'Privacy system',
    'casosEstudio.verdePrive.metrics.premiumPositioning': 'Premium positioning',
    'casosEstudio.verdePrive.testimonial.text': 'Combining artisanal quality with total discretion redefines the premium cannabis experience',
    'casosEstudio.verdePrive.testimonial.author': 'Verde Privé Development Team',
    'casosEstudio.maalcaProperties.title': 'MaalCa Properties: Global Tourism Investment',
    'casosEstudio.maalcaProperties.category': 'Tourism + Real Estate',
    'casosEstudio.maalcaProperties.challenge': 'Connect global investors with Dominican tourism properties',
    'casosEstudio.maalcaProperties.solution': 'A platform specialized in oceanfront properties with full-service management',
    'casosEstudio.maalcaProperties.results.properties': '25+ properties managed',
    'casosEstudio.maalcaProperties.results.investors': 'Investors from 15 countries',
    'casosEstudio.maalcaProperties.results.roi': '18% average annual ROI',
    'casosEstudio.maalcaProperties.results.satisfaction': '100% investor satisfaction',
    'casosEstudio.maalcaProperties.metrics.activeProperties': 'Active properties',
    'casosEstudio.maalcaProperties.metrics.investorCountries': 'Investor countries',
    'casosEstudio.maalcaProperties.metrics.avgRoi': 'Average annual ROI',
    'casosEstudio.maalcaProperties.metrics.investorSatisfaction': 'Investor satisfaction',
    'casosEstudio.maalcaProperties.testimonial.text': 'Local expertise combined with an international vision made our Caribbean investments a reality',
    'casosEstudio.maalcaProperties.testimonial.author': 'International Investor',
  }
};
...
export function useSimpleLanguage() {
  // Always start with the SSR-safe default — localStorage is only readable client-side,
  // so reading it inside the useState initializer causes a server/client hydration mismatch.
