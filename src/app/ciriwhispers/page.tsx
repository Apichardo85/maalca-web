  ...
  return (
    <section className="min-h-[calc(100vh-4rem)] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <div className="absolute top-20 left-10 text-4xl text-red-700/40 animate-pulse">
          &bull;
        </div>
        <div
          className="absolute top-40 right-20 text-3xl text-stone-200/40 animate-pulse"
          style={{ animationDelay: "1s" }}
        >
          &bull;
        </div>
        <div
          className="absolute bottom-20 left-20 text-4xl text-red-800/40 animate-pulse"
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        {/* Hook phrase */}
        <h1
          className="font-serif text-4xl sm:text-5xl md:text-7xl font-bold mb-6 animate-fade-in-up leading-tight"
        >
          <span className="bg-gradient-to-r from-red-800 via-red-500 to-red-800 bg-clip-text text-transparent">
            Lo bello tambien sangra
          </span>
          <br />
          <span className="text-stone-200 text-2xl sm:text-3xl md:text-4xl font-light italic">
            ...pero aqui se escribe.
          </span>
        </h1>

        <p
          className="text-slate-400 text-lg md:text-xl max-w-xl mx-auto mb-12 leading-relaxed animate-fade-in-up"
          style={{ animationDelay: "0.3s" }}
        >
          Microcuentos, poemas, cartas y novelas. Historias que no se cuentan en
