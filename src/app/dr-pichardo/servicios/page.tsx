    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          {/* Category Filters */}
          <div className="animate-fade-in-up flex flex-wrap justify-center gap-3 mb-12" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8">
            {filteredServices.map((service, index) => (
              <div
                key={service.id}
                className={`animate-fade-in-up bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group ${
