...
// Personal operativo del negocio (meseros, barberos, etc.) — proxya a /api/affiliates/{id}/team.
// No confundir con /api/space/[slug]/team, que es "quién entra al dashboard" (collaborators).
export async function GET(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/team`, {
