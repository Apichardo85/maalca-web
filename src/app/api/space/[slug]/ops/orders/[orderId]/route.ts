...
// Borrado real de una orden suelta — mismo criterio que .../ops/customers, ver ese archivo.
export async function DELETE(
  ...
  const apiRes = await fetch(`${API}/api/ops/affiliates/${affiliate.id}/orders/${orderId}`, {
    method: 'DELETE',
