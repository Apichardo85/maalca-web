...
// Marcar pagada/cancelar una factura — PUT completo (el backend reemplaza los campos editables).
export async function PUT(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/invoices/${id}`, {
    method: 'PUT',
    headers: {
