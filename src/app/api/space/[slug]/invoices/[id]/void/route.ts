...
// Anular una factura (no se edita ni se borra — documento financiero). Proxya a
// POST /api/affiliates/{id}/invoices/{id}/void { reason }.
export async function POST(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/invoices/${id}/void`, {
    method: 'POST',
    headers: {
