...
// Facturación para negocios de Servicios/Profesionales — proxya a /api/affiliates/{id}/invoices.
export async function GET(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/invoices${qs}`, {
...
export async function POST(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/invoices`, {
    method: 'POST',
    headers: {
