...
// Modulo Eventos/Actividades (backlog 2026-09-25) -- mismo patron proxy que /services.
// Lanzamiento inicial solo Community (gateado en SpaceSidebar/ActivitiesContent, no aqui).
export async function GET(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/activities`, {
