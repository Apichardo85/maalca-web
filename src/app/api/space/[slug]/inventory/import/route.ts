...
// Importa items desde un CSV (mismo formato que exporta /inventory/export) — carga inicial rápida
// en vez de agregar item por item.
export async function POST(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/inventory/import`, {
    method: 'POST',
    headers: {
