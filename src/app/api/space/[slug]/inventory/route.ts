...
// Inventario de insumos/consumibles (Restaurante/Retail) — proxya a /api/affiliates/{id}/inventory.
export async function GET(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/inventory${qs}`, {
...
export async function POST(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/inventory`, {
    method: 'POST',
    headers: {
