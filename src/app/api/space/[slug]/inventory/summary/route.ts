...
// Valor total del inventario + items en stock bajo — usado por Inventario y por la alerta del
...
export async function GET(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/inventory/summary`, {
