...
// Receta (ProductIngredient) de un plato del Catálogo — Restaurante. `id` acá es el Product.Id
// (mismo id que /catalog/[id]), no un InventoryItem — el backend resuelve la relación.
export async function GET(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/products/${id}/ingredients`, {
