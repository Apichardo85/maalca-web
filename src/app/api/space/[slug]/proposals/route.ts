...
// Propuestas de servicio con firma/aceptación pública (task #194) — proxya a
// /api/affiliates/{id}/proposals. Ver Proposal.cs en maalca-api.
export async function GET(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/proposals`, {
