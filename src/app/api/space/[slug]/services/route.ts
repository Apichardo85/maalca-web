...
// Lista de servicios (Service, no Product/InventoryItem) — usado por Agenda para elegir qué
// servicio se está reservando. Distinto del catálogo genérico de /space/[slug]/catalog.
export async function GET(
  ...
  const apiRes = await fetch(`${API}/api/affiliates/${affiliate.id}/services`, {
