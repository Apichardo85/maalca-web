        ...
        <section className="tld-hero">
          ...
          <div className="tld-hero-content">
            ...
            <p style={{ fontSize:'1.05rem', fontWeight:600, color:'#fff', marginBottom:'2rem', letterSpacing:'.01em' }}>
              Ordena ahora. Listo en minutos.
            </p>
            <div style={{ display:'flex', flexWrap:'wrap', gap:'12px', alignItems:'center' }}>
              <a
                href={`https://wa.me/16072150990?text=${encodeURIComponent('Hola, quiero ordenar. ¿Qué tienen disponible ahora?')}`}
                target="_blank"
                rel="noopener noreferrer"
                className="btn-wa"
              >
                <WhatsAppIcon /> Ordenar por WhatsApp
              </a>
            ...
            <div style={{ display:'flex', flexWrap:'wrap', gap:'7px', marginTop:'1.75rem' }}>
              {['Dine-in','Pickup','Delivery','$10–20'].map(s => (
          ...
          <div className="tld-sanctuary-content">
            <div style={{ maxWidth:'680px' }}>
              ...
              <p style={{ fontSize:'.95rem', fontWeight:300, lineHeight:1.7, color:'rgba(255,255,255,.75)', marginBottom:'2.5rem' }}>
                Ambiente familiar, sazón auténtico y la mejor cocina dominicana de Elmira, NY —
                lista para pickup, delivery o para comer aquí. Ven a vivir la experiencia.
              </p>
            </div>
            {/* Stats row */}
            <div style={{ display:'flex', flexWrap:'wrap', gap:'1rem', marginTop:'.5rem' }}>
              {[
                { icon:'⚡', label:'Pickup listo', sub:'En 20–30 minutos' },
        ...
        <section style={{ background:'var(--p)', padding:'clamp(3rem,6vw,5rem) clamp(1.5rem,5vw,5rem)' }}>
          <div style={{ maxWidth:'920px', margin:'0 auto', textAlign:'center' }}>
            ...
            <h2 style={{ fontFamily:'Newsreader,Georgia,serif', fontSize:'clamp(1.8rem,3.5vw,2.6rem)', fontWeight:300, color:'#fff', letterSpacing:'-.015em', lineHeight:1.15, marginBottom:'.75rem' }}>
              Pide tu comida<br />
              <em style={{ fontStyle:'italic', color:'rgba(255,255,255,.85)' }}>dominicana</em> ahora mismo
            </h2>
            <p style={{ fontSize:'.95rem', fontWeight:300, color:'rgba(255,255,255,.7)', maxWidth:'52ch', margin:'0 auto 2rem' }}>
              Respuesta en minutos por WhatsApp — te confirmamos disponibilidad y tiempo de entrega al momento.
            </p>
