      ...
      <div className="tld" style={{ paddingTop: '60px' }}>
        ...
        <section style={{ background:'var(--p)', padding:'clamp(3rem,6vw,5rem) clamp(1.5rem,5vw,5rem)' }}>
          <div style={{ maxWidth:'1280px', margin:'0 auto', textAlign:'center' }}>
            <div className="tld-label" style={{ color:'rgba(255,255,255,.5)', marginBottom:'.75rem' }}>Síguenos</div>
            ...
            <p style={{ fontSize:'.88rem', fontWeight:300, color:'rgba(255,255,255,.6)', marginBottom:'2.5rem' }}>
              Ofertas especiales, eventos y el menú del día — directo a tu feed.
            </p>

            <div style={{ display:'flex', justifyContent:'center', gap:'1rem', flexWrap:'wrap' }}>

              {/* Facebook */}
              <a href="https://facebook.com/thelittledominican" target="_blank" rel="noopener noreferrer"
                style={{ display:'flex', alignItems:'center', gap:'10px', padding:'13px 24px', borderRadius:'9999px', background:'rgba(255,255,255,.1)', border:'1px solid rgba(255,255,255,.15)', textDecoration:'none', color:'#fff', fontSize:'.85rem', fontWeight:600, transition:'background .15s' }}
              ...
              {/* Instagram */}
              <a href="https://instagram.com/thelittledominican" target="_blank" rel="noopener noreferrer"
                style={{ display:'flex', alignItems:'center', gap:'10px', padding:'13px 24px', borderRadius:'9999px', background:'rgba(255,255,255,.1)', border:'1px solid rgba(255,255,255,.15)', textDecoration:'none', color:'#fff', fontSize:'.85rem', fontWeight:600, transition:'background .15s' }}
                onMouseEnter={e => (e.currentTarget.style.background='rgba(255,255,255,.18)')}
                onMouseLeave={e => (e.currentTarget.style.background='rgba(255,255,255,.10)')}
              >
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/16072150990" target="_blank" rel="noopener noreferrer"
                style={{ display:'flex', alignItems:'center', gap:'10px', padding:'13px 24px', borderRadius:'9999px', background:'#25d366', border:'1px solid #25d366', textDecoration:'none', color:'#fff', fontSize:'.85rem', fontWeight:600, transition:'opacity .15s' }}
